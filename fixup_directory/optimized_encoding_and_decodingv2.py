...
f= open('/home/meow/pytohn_codes/ergasia_patsaki/ff7.webp','rb')
bin = f.read()
f.close()
#print(bin)
flag=0
megethos_eikonas=os.path.getsize('/home/meow/pytohn_codes/ergasia_patsaki/ff7.webp')
...
compressed_size_to_send=get_size(lista_oxi_midenikon)+get_size(lista_apothikeuseis_arhikon_pososton)+get_size(lista_apothikeusis_liston_monadikon_xarakthron)#έστω οτι αυτός ο κώδικας δουλεύει

compressed_sizecounter=0
for item in lista_oxi_midenikon:
    compressed_sizecounter+=sys.getsizeof(item)
...
print(teliko_string==hex_bin)
exit()
f= open('/home/meow/pytohn_codes/ergasia_patsaki/finalphoto2.webp','br+')
...
megethos_eikonas=os.path.getsize('/home/meow/pytohn_codes/ergasia_patsaki/photo3.webp')
