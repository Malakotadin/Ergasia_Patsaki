...
with open("tag_ls2",'ab') as tag_file ,  open("arithmos_bit2",'rb') as arithmos_bit , open("ls_pososta_ls2",'rb') as ls_pososta_ls , open("ls_xarakthres_ls2",'rb') as ls_xarakthres_ls , open("noumero2",'rb') as noumero,open("diafora2",'rb')as diafora :
