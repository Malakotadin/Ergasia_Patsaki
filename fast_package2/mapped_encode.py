...
def encoder(demo_string):
   ...
   # demo_string=sys.argv[1]
    ...
    lista_epistrogis=[]
    lista_epistrogis.append(timoula)
    lista_epistrogis.append(lista_arhikon_pososton)
    lista_epistrogis.append(lista_monadikon_xarakthron)
    return lista_epistrogis
